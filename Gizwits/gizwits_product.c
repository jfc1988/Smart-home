  ...
  for(i=0; i<info->num; i++)
  {
    switch(info->event[i])
    {
      case EVENT_led:
        ...
        break;
      case EVENT_jidianqi:
        currentDataPoint.valuejidianqi = dataPointPtr->valuejidianqi;
        GIZWITS_LOG("Evt: EVENT_jidianqi %d \n", currentDataPoint.valuejidianqi);
        if(0x01 == currentDataPoint.valuejidianqi)
        {
        ...
        break;
      case EVENT_jidianqi2:
        currentDataPoint.valuejidianqi2 = dataPointPtr->valuejidianqi2;
        GIZWITS_LOG("Evt: EVENT_jidianqi2 %d \n", currentDataPoint.valuejidianqi2);
        if(0x01 == currentDataPoint.valuejidianqi2)
        {
